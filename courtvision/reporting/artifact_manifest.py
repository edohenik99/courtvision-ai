...
def _specs(prediction_date: str) -> tuple[ArtifactSpec, ...]:
    return (
        ...
        # Phase 6A Learning Artifacts — optional/reporting-only; not an Elite, Kelly,
        # final decision, or staking input.  Missing these never causes fatal_missing.
        ArtifactSpec(
            "learning_artifacts_reporting",
            "learning_brain_report_txt",
            "operator",
            f"learning_brain_report_{prediction_date}.txt",
            SEVERITY_SHADOW_ONLY,
        ...
        ArtifactSpec(
            ...
            "diagnostics",
            f"learning_brain_report_{prediction_date}.json",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "operator",
            f"shadow_rule_proposals_{prediction_date}.txt",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "diagnostics",
            f"shadow_rule_proposals_{prediction_date}.json",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "operator",
            f"learning_integration_snapshot_{prediction_date}.txt",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "diagnostics",
            f"learning_integration_snapshot_{prediction_date}.json",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "operator",
            f"learning_artifacts_summary_{prediction_date}.txt",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
        ArtifactSpec(
            ...
            "diagnostics",
            f"learning_artifacts_summary_{prediction_date}.json",
            SEVERITY_SHADOW_ONLY,
            "Optional Phase 6A learning artifacts reporting; not an Elite, Kelly, final decision, or staking input.",
        ),
