...
class EventType(str, Enum):
    ...
    OFFICIAL_PICK_CANDIDATE_REVIEWED = "OFFICIAL_PICK_CANDIDATE_REVIEWED"
    OFFICIAL_PICK_PUBLISHED = "OFFICIAL_PICK_PUBLISHED"
    OFFICIAL_PICK_SETTLED = "OFFICIAL_PICK_SETTLED"
    OFFICIAL_PICK_CORRECTION_RECORDED = "OFFICIAL_PICK_CORRECTION_RECORDED"
    OFFICIAL_PICK_SETTLEMENT_CORRECTION_RECORDED = (
        "OFFICIAL_PICK_SETTLEMENT_CORRECTION_RECORDED"
    )
